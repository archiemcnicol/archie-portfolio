...
/**
 * First public edit from the photography archive. The source filenames and
 * capture metadata stay attached internally so the edit can be expanded into
 * projects without exposing raw filenames in the public UI.
 */
